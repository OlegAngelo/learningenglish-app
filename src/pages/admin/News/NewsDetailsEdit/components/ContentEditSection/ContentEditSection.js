...
import styles from './ContentEditSection.module.css';

const ContentEditSection = () => {
          ...
          <tr key={key}>
            ...
            <td className="pb-px-4">
              <input
                ...
                name="title"
                id="title"
                className="bg-gray-50 p-px-11 border border-gray-300 rounded-px-2 text-gray-900 focus:outline-none"
      ...
      <div className="my-px-40">
        ...
        <div className={`mt-px-40 ${styles.contentWidth}`}>
          <div className={openTab === 1 ? 'block' : 'hidden'} id="link1">
            <textarea
              style={{ height: '740px', width: '542px' }}
              className="m-w-full text-14 leading-px-24 font-normal text-basic-100 bg-gray-50 p-px-12 whitespace-pre-wrap focus:outline-none"
              cols="80"
              name="content"
              id="content"
