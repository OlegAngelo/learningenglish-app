...
const FilterSection = () => {
  ...
  const { level } = useSelector((state) => state.selfLearningReadingList);
  ...
  return (
    <>
      ...
      <h2 className="px-px-16 pt-px-16 text-18 font-bold font-hiragino text-primary-500 bg-background-200">{`Level ${level.order}`}</h2>
