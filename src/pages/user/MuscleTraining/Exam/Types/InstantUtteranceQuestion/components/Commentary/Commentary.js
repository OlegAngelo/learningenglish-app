...
import style from '../../../SentenceReadingQuestion/SentenceReadingQuestion.module.css'
...
const Commentary = ({
  ...
  return (
    <div className="-mb-px-20">
      <div className={`mx-px-22 mt-px-60`}>
        <p className="text-24 leading-px-35.52 text-basic-100 ">
          {question}
        </p>
        <p className={`text-18 text-basic-100 mt-px-9 ${style.subQuestion}`}>
          {subQuestion}
        </p>
      ...
      <div className={`mt-px-28 ${pronunciationPoint ? '' : 'mb-px-100'} `}>
        <CommentaryCard
          title="解説"
