...
import styles from './PhraseVoiceListening.module.css';

const PhraseVoiceListening = () => {
  const {
    footerProps,
    setFooterProps,
    isShowCommentary,
      ...
      <div className={`mx-px-8 ${styles.contentContainer}`}>
        {isShowCommentary
          ? (
            ...
            isAudioEnded && (
              <div className={`${styles.questionChoiceList}`}>
                <div
...
export default PhraseVoiceListening;
