  ...
  return (
    <div className="px-px-16 bg-background-200">
      <div className="flex justify-center">
        <h4 className={`text-14 text-primary-500 text-center font-bold mb-px-40 ${styles.situation}`}>
          Situationを確認しましょう
        </h4>
      </div>

      <p className="text-14 text-primary-500 leading-px-14 mb-px-12">
        Situation
      </p>
      ...
      <div className="bg-white rounded-px-4 p-px-15 mb-px-8 h-px-80">
        <p className={`${styles.situationDescription} text-14 text-basic-100 mt-px-2 mr-px-2`}>
          会議終了後，部署のメンバーに議事録を送るメールを打っています。
        </p>
      </div>
